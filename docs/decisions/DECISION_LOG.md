...
We will organise the knowledge platform around retaining wall product/system types, not individual supplier brand names.

Example:
- Use "Segmental Block Retaining Walls" as the product topic.
